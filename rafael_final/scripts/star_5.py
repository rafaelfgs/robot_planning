...
def verify_changes():
    ...
    while i_goal != i_goal_old or j_goal != j_goal_old or \
        ...
        sys.stdout.write("Verficada mudanca na posicao\n")
        pos_changed = True
...
def set_next_point():
    ...
    #print j_curr, j_next, i_curr, i_next
    #print x_curr, x_next, y_curr, y_next
...
def star():
    ...
    #a[a==0] = 255
    #a[a>255] = 0
    #cv2.imwrite("/home/rafael/Desktop/lavabeds_grid_4.png",a)
    #print asdf

    # Enquanto o programa nao for interrompido
    while not rospy.is_shutdown():

        #print i_next, i_curr, i_goal, i_goal_old
        #print j_next, j_curr, j_goal, j_goal_old
        ...
        #print i_next, i_curr, j_next, j_curr
